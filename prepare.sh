...
cp $LIB_DIR/apache-log4j/javalib/log4j-api-2.11.0.jar $REPO_DOCKER/oscm-gf/
cp $LIB_DIR/apache-log4j/javalib/log4j-core-2.11.0.jar $REPO_DOCKER/oscm-gf/
...
cp $LIB_DIR/apache-log4j/javalib/log4j-core-2.11.0.jar $REPO_DOCKER/oscm-initdb/
cp $LIB_DIR/apache-log4j/javalib/log4j-api-2.11.0.jar $REPO_DOCKER/oscm-initdb/
...
cp $LIB_DIR/apache-log4j/javalib/log4j-core-2.11.0.jar $REPO_DOCKER/oscm-core/
cp $LIB_DIR/apache-log4j/javalib/log4j-api-2.11.0.jar $REPO_DOCKER/oscm-core/
...
cp $LIB_DIR/apache-log4j/javalib/log4j-core-2.11.0.jar $REPO_DOCKER/oscm-app/
cp $LIB_DIR/apache-log4j/javalib/log4j-api-2.11.0.jar $REPO_DOCKER/oscm-app/
