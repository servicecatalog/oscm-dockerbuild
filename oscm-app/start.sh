...
/usr/bin/envsubst '$PROXY_SET $PROXY_HOST $PROXY_PORT $NON_PROXY_HOSTS' < /opt/apache-tomee/bin/catalina_template.sh > /opt/apache-tomee/bin/catalina.sh
/usr/bin/envsubst '$PROXY_SET $PROXY_HOST $PROXY_PORT $NON_PROXY_HOSTS' < /opt/apache-tomee/conf/catalina_template.properties > /opt/apache-tomee/conf/catalina.properties
